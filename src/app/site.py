...
def _base_css() -> str:
    return (
        ...
        ".quick-win{background:linear-gradient(135deg,#064e3b,#065f46);border:1px solid #10b981;border-radius:12px;padding:20px;margin:25px 0;box-shadow:0 8px 20px rgba(16,185,129,0.15);position:relative;}"
        ".quick-win h3{margin-top:0;color:#34d399;font-size:20px;text-transform:uppercase;letter-spacing:0.05em;}"
        ".quick-win p{margin-bottom:0;font-weight:500;}"
        ".myth-fact{background:#111827;border:2px solid #374151;border-radius:16px;overflow:hidden;margin:30px 0;box-shadow:0 10px 30px rgba(0,0,0,0.3);}"
        ".myth-header{background:#991b1b;color:white;padding:10px 20px;font-weight:800;text-transform:uppercase;font-size:15px;letter-spacing:0.1em;display:flex;align-items:center;gap:10px;}"
        ".myth-header::before{content:'✕';font-size:18px;}"
        ".fact-header{background:#065f46;color:white;padding:10px 20px;font-weight:800;text-transform:uppercase;font-size:15px;letter-spacing:0.1em;display:flex;align-items:center;gap:10px;}"
        ".fact-header::before{content:'✓';font-size:18px;}"
        ".myth-body{padding:15px 20px;color:#fca5a5;font-style:italic;border-bottom:1px solid #374151;}"
        ".fact-body{padding:15px 20px;color:#d1fae5;font-weight:500;}"
        "blockquote{border-left:5px solid #3b82f6;background:linear-gradient(90deg,rgba(59,130,246,0.15),transparent);margin:25px 0;padding:20px 25px;font-style:italic;border-radius:0 16px 16px 0;color:#bfdbfe;}"
